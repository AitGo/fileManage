 ...
 * @更新描述
 */
public class LayerChooseAdapter extends BaseAdapter {

    private Context mContext;
    private List<String> list;

    public LayerChooseAdapter(Context mContext, List<String> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.mLayer.setText("第" + list.get(position) + "层");
        return convertView;
    }
